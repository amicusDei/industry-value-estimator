    ...
    for year, half in all_periods:
        ...
        row = {
            ...
            **scores,
            ...
            # Raw metrics for transparency (used by frontend context lines)
            "capex_intensity_ratio": round(capex_ratio, 2),
            "hyperscaler_ai_capex_usd_b": capex_entry.get("hyperscaler_ai_capex_usd_b", 0),
            "ai_revenue_usd_b": capex_entry.get("ai_revenue_usd_b", 0),
            "ai_revenue_hhi": conc_entry.get("ai_revenue_hhi", 0),
            "top_player_ai_share_pct": conc_entry.get("top_player_ai_share_pct", 0),
            "new_capacity_mw": dc_entry.get("new_capacity_mw", 0),
            "dc_yoy_growth_pct": dc_growth,
            "credit_total_usd_b": round(credit_total, 1),
            "hyperscaler_bonds_usd_b": credit_entry.get("hyperscaler_bonds_usd_b", 0),
            "private_credit_ai_usd_b": credit_entry.get("private_credit_ai_usd_b", 0),
            "off_balance_sheet_est_usd_b": credit_entry.get("off_balance_sheet_est_usd_b", 0),
